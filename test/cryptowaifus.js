            ...
            return CryptoWaifus.deployed().then(function (instance) {
                ...
                Promise.all(reservationPromises).then(function() {
                    ...
                    Promise.all(promises).then(function() {
                        ...
                        return contract.offerWaifuForSale(1001, 100, {from: accounts[1]});
                    }).then(function () {
                        ...
                        return contract.buyWaifu(1001, {from: accounts[0], value: 100});
                        ...
                        return contract.offerWaifuForSaleToAddress(1001, 100, accounts[2], {from: accounts[0]});
                       // return contract.punkIndexToAddress(1001);
                    }).then(function (address) {
                        console.log("Try to get account 1 to buy punk 1001 but fail.");
                        return contract.buyWaifu(1001, {from: accounts[1], value: 100});
                    }).then(function () {
                        // console.log("Bought punk.");
                        assert(false, "Was supposed to throw but didn't.");
                    }).catch(function (error) {
                        ...
                        return contract.offerWaifuForSale(1001, 100, {from: accounts[2]});
                    }).then(function (address) {
                        ...
                        assert.equal(balance, 100, "Account 0 balance incorrect.");
                    }).then(function () {
                        ...
                        assert.equal(Number(subCurrBalance), Number(subPrevBalance) + 100, "Account 0 balance incorrect after withdrawal.");
                    })
                        // return contract.nextWaifuIndexToAssign();
                })
        });

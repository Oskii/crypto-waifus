...
contract("CryptoWaifusMarket-edgecases", function (accounts) {
  it("re-assign a punk during assignment phase, assign same punk twice", async function () {
    ...
    // Assign a two waifus, then re-assign one of them
    ...
    // Check the number of waifus left to assign
    var leftToAssign = await contract.waifusRemainingToAssign.call();

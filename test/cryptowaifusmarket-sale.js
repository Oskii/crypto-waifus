...
contract("CryptoWaifusMarket-buySellRemoveFromSale", function (accounts) {
  it("can not offer for sale allWaifusAssigned = false", async function () {
    ...
    it("can buy a punk that is for sale", async function () {
      ...
      assert.equal(
        balanceToWidthdraw.valueOf(),
        1000,
        "Balance not available to withdraw."
      );
    }),
